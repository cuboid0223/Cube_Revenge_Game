...
const DemoLevel1 = {
  ...
  placements: [
    ...
    { type: "CONVEYOR", x: 2, y: 5, direction: "UP" },
    { type: "CONVEYOR", x: 3, y: 5, direction: "LEFT" },
    { type: "CONVEYOR", x: 4, y: 5, direction: "RIGHT" },
    { type: "ICE", x: 1, y: 3, corner: "BOTTOM_LEFT" },
    { type: "ICE", x: 2, y: 3 },
    { type: "ICE", x: 3, y: 3, corner: "TOP_RIGHT" },
    { type: "ICE", x: 3, y: 4, corner: "BOTTOM_LEFT" },
    { type: "ICE", x: 4, y: 4, corner: "BOTTOM_RIGHT" },
    { type: "ICE", x: 4, y: 3, corner: "TOP_LEFT" },
    { type: "LOCK", x: 10, y: 1, color: "BLUE" },
    { type: "LOCK", x: 9, y: 1, color: "GREEN" },
    { type: "SWITCH", x: 4, y: 1 },
    { type: "SWITCH_DOOR", x: 5, y: 1, isRaised: false },
    { type: "SWITCH_DOOR", x: 6, y: 1, isRaised: true },
    { type: "WATER", x: 8, y: 4 },
    { type: "THIEF", x: 8, y: 3 },
    { type: "KEY", x: 9, y: 2, color: "GREEN" },
    { type: "KEY", x: 10, y: 2, color: "BLUE" },
    { type: "ICE_PICKUP", x: 3, y: 2 },
    { type: "WATER_PICKUP", x: 7, y: 4 },
    { type: "FIRE_PICKUP", x: 7, y: 5 },
